...
| Phase 7 / G8 | PASS (pending final run) | ~within est | 120K | 40 tests (1:1 INVARIANTS), deterministic demo, self-verifying examples, full house doc set (0 OPUS-FILLS markers, README quickstart executes), numpy byte-identical, CHANGELOG hardening pass. RG-4 found+fixed (retire self-sufficiency). Docs bar (NON-NEGOTIABLE) met. |
